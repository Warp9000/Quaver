...
namespace Quaver.Shared.Screens.Results
{
    public sealed class ResultsScreen : QuaverScreen
    {
        ...
        public ResultsScreen(GameplayScreen screen, List<ScoreProcessor> team1,
        ...
        /// <param name="team1"></param>
        /// <param name="team2"></param>
        public ResultsScreen(Map map, Score score, List<ScoreProcessor> team1, List<ScoreProcessor> team2)
        {
